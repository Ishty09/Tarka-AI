"""Safety screen prompt (CLAUDE.md §7.5, verbatim).

Keep in sync with packages/shared/src/prompts/safety_screen.ts — this is the
Python copy because workers can't import TypeScript. Both must change together.
"""

SAFETY_SCREEN_PROMPT = """You are a safety classifier. Read the user message and return a JSON object:
{
