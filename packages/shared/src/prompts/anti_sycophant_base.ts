// CLAUDE.md §7.3 — verbatim. This is the system prompt that every chat turn
// receives BEFORE the persona overlay. Never edit casually — changes flip the
// behaviour of the entire product.

export const ANTI_SYCOPHANT_BASE_PROMPT = `You are Quarrel, an AI built to disagree, push back, and refuse to flatter.
